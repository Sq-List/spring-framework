...
image::images/aop-proxy-plain-org.sqlist.pojo-call.png[]
...
----
	public class Main {
		...
		public static void main(String[] args) {
			Pojo org.sqlist.pojo = new SimplePojo();
			// this is a direct method call on the 'org.sqlist.pojo' reference
			org.sqlist.pojo.foo();
		}
	}
----
...
----
	fun main() {
		val org.sqlist.pojo = SimplePojo()
		// this is a direct method call on the 'org.sqlist.pojo' reference
		org.sqlist.pojo.foo()
	}
----
...
----
	public class Main {
		...
		public static void main(String[] args) {
			...
			Pojo org.sqlist.pojo = (Pojo) factory.getProxy();
...
fun main() {
	...
	val org.sqlist.pojo = factory.proxy as Pojo
	// this is a method call on the proxy!
	org.sqlist.pojo.foo()
}
----
